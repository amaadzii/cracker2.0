    ...
    <aside class="left-sidebar" data-sidebarbg="skin5">
        ...
        <div class="scroll-sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link active waves-effect waves-dark sidebar-link" href="/admin/info-vaksinasi"
                    aria-expanded="false">
    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-5 align-self-center">
                <h4 class="page-title">Vaksinasi</h4>
            </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-body">
                    <h4 class="card-title">Kelola Informasi Vaksinasi</h4>
                    <form action="/admin/tambah-vaksinasi">
                    ...
                    <div class="table-responsive-xl">
                        <table class="table">
                            ...
                            $query = mysqli_query($connection, "SELECT * FROM info_vaksin");
                            $no = 1;

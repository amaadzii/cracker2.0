...
<head>
    ...
    <title>Infografis | Admin Cracker 2.0</title>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-body">
                    <h4 class="card-title">Kelola Konten Infografis</h4>
                    <form action="/admin/tambah-infografis">
                    ...
                    <div class="table-responsive-xl">
                        <table class="table">
                            ...
                            $query = mysqli_query($connection, "SELECT * FROM infografis");
                            $no = 1;

...
<head>
    ...
    <title>Dashboard | Admin Cracker 2.0</title>
            ...
            <nav class="sidebar-nav">
                <ul id="sidebarnav">
                    <li class="sidebar-item">
                        <a class="sidebar-link active waves-effect waves-dark sidebar-link" href="/admin/dashboard"
                        aria-expanded="false">
...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Admin Guide</h4>
                    <h3>Welcome to Admin Page Cracker 2.0!</h3>
                    <h5>> Informasi Vaksinasi</h5>
                    <h5>> Rumah Sakit Rujukan</h5>
                    <h5>> Konten Infografis</h5>
                    <h5>> Konten Edukasi</h5>
                </div>
            </div>
        </div>
    </div>

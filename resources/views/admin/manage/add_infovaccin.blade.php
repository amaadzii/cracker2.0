...
<head>
    ...
    <title>Tambah Vaksinasi | Admin Cracker 2.0</title>
    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-5 align-self-center">
                <h4 class="page-title">Informasi Vaksinasi</h4>
            </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-body">
                    <h4 class="card-title">Tambah Informasi Vaksinasi</h4>

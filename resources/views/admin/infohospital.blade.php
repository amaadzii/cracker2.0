...
<head>
    ...
    <title>Rumah Sakit Rujukan | Admin Cracker 2.0</title>
...
<body>
    ...
    <aside class="left-sidebar" data-sidebarbg="skin5">
        ...
        <div class="scroll-sidebar">
            ...
            <li class="sidebar-item">
                <a class="sidebar-link active waves-effect waves-dark sidebar-link" href="/admin/info-rumahsakit"
                aria-expanded="false">
    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-5 align-self-center">
                <h4 class="page-title">Rumah Sakit Rujukan</h4>
            </div>
                ...
                <div class="d-flex align-items-center justify-content-end">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Rumah Sakit Rujukan</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-body">
                    <h4 class="card-title">Kelola Informasi Rumah Sakit Rujukan</h4>
                    <form action="/admin/tambah-rumahsakit">
